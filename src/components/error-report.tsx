    ...
    return (
        <Splash image={<StaticImage src="../images/con-cats/ticket-types/day.png" alt="" />}>
            ...
            <Localized id="funnel-error-report-message" vars={{ category, code }}>
                <ReactMarkdown>
                    An error occurred when we tried to handle your request. Please try again later. If this problem
                    persists, try clearing your browser&apos;s cache and refreshing the page. If that doesn&apos;t
