            ...
            <Grid>
                ...
                <Links>
                    <Localized id="footer-links-privacy-policy">
                        <a target="_blank" rel="noreferrer noopener" href={config.websiteLinks.privacyStatement}>
                            Privacy policy
                        </a>
                    </Localized>
                    <Localized id="footer-links-legal-info">
                        <a target="_blank" rel="noreferrer noopener" href={config.websiteLinks.imprint}>
                            Legal info
                        </a>
                    </Localized>
                    <Localized id="footer-links-policies">
                        <a target="_blank" rel="noreferrer noopener" href={config.websiteLinks.policies}>
                            Policies
                        </a>
                    </Localized>
                    <Localized id="footer-links-contact">
                        <a target="_blank" rel="noreferrer noopener" href={config.websiteLinks.contact}>
                            Contact Eurofurence
                        </a>
                    </Localized>
                </Links>
                <Credits>
                    Artwork © 2022{' '}
                    <a target="_blank" rel="noreferrer noopener" href="http://pan-hesekiel-shiroi.de/">
                        Pan Hesekiel Shiroi
                    </a>
                </Credits>
            </Grid>
