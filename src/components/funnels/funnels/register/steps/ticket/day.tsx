...
const TicketDay = (_: ReadonlyRouteComponentProps) => {
	...
	const conCats = [
		null,
		<StaticImage
			src="../../../../../../images/con-cats/days/monday.png"
			alt=""
		/>,
		<StaticImage
			src="../../../../../../images/con-cats/days/tuesday.png"
			alt=""
		/>,
		<StaticImage
			src="../../../../../../images/con-cats/days/wednesday.png"
			alt=""
		/>,
		<StaticImage
			src="../../../../../../images/con-cats/days/thursday.png"
			alt=""
		/>,
		<StaticImage
			src="../../../../../../images/con-cats/days/friday.png"
			alt=""
		/>,
		<StaticImage
			src="../../../../../../images/con-cats/days/saturday.png"
			alt=""
		/>,
		<StaticImage
			src="../../../../../../images/con-cats/days/sunday.png"
			alt=""
		/>,
	]
	...
	return (
		<FullWidthRegisterFunnelLayout
			...
			showBack={true}
		>
			<Localized id="register-ticket-day-title">
					...
					<Grid>
						{eachDayOfInterval(
							Interval.fromDateTimes(
								config.dayTicketStartDate,
								config.dayTicketEndDate,
							),
						).map((date) => (
							<Localized
								id="register-ticket-day-card"
								key={date.toISODate()}
								attrs={{ label: true }}
								vars={{ date: createLuxonFluentDateTime(date) }}
							>
								<RadioCard
									label={date.toString()}
