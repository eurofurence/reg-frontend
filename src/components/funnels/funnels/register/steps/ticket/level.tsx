...
const TicketLevel = (_: ReadonlyRouteComponentProps) => {
    ...
    const nonSelectedAddonIds = Object.entries(formContext.getValues('addons') as AddonSelection)
                ...
                {ticketType.type !== 'day' ? (
                    <ModifiersSection>
                        ...
                        <Localized
                            ...
                            attrs={{ label: true, description: true, price: true }}
                        >
                            <TicketLevelFootnote marker="" label="Late Fee" price="+15"></TicketLevelFootnote>
                        </Localized>
                        <Localized
                ...
                <AddonsSection>
                    ...
                    <AddonsContainer>
                        {Object.entries(config.addons)
                            ...
                            .filter(
                                ([, addon]) =>
                                    !(addon.unavailableFor?.level?.includes(formContext.getValues('level')) ?? false),
                            )
