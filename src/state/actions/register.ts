...
export const LoadRegistrationState = createAction<RegisterState, '[Register] Load registration state'>(
...
export const InitiateSepaPayment = createAction<undefined, '[Register] Initiate SEPA payment'>(
