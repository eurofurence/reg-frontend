...
export declare type DeepField<T> = T extends boolean
  ? T
  : // : '' extends T
    // ? T
    T extends Builtin
...
export type FormValuesType<FId extends FormIds> = DeepField<
  FormValuesTypes[FId]
>
