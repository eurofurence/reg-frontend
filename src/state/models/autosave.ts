                  ...
                  ticketType:
                      saveData.registrationInfo.ticketType === undefined
                          ...
                          : saveData.registrationInfo.ticketType.type !== 'day'
                            ...
                            : {
                                  ...saveData.registrationInfo.ticketType,
                                  day: DateTime.fromISO(saveData.registrationInfo.ticketType.day, {
                                      zone: 'Europe/Berlin',
                                  }),
                              },
                  personalInfo:
...
const isConfiguredAsAddon = (idCandidate: string): boolean => {
    return Object.entries(config.addons).some(([id, _ignored]) => idCandidate === id)
}
...
const hasWrongAddons = (addons: TicketLevelAddons): boolean => {
    return Object.entries(addons).some(([id, _ignore]) => !isConfiguredAsAddon(id))
}
